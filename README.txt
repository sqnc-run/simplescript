...
A desktop app (Python + tkinter) that connects to sqnc.run over WebSocket, watches a live stream of 7x7 binary frames, and alerts you when a frame sequence you define ("trigger") shows up.
...
API documentation
------------------
Full documentation for the sqnc.run WebSocket (listen) and HTTP (inject) API is in DOCS.md.
